...
class Passport
{
	...
	public function __construct()
	{
		...
		$this->cfg['FontBold'] = pll__('LanguageFontBold');
		$this->cfg['FontRegular'] = pll__('LanguageFontRegular');
		$this->cfg['FontItalic'] = pll__('LanguageFontItalic');
		...
		$this->pdf->setRTL(true);
		$this->pdf->Rect($this->cfg['PagePaddingLeft'], $this->cfg['PagePaddingTop']+16, 88, 125, 'F', array('all' => array()), $this->cfg['Green']);
		$this->pdf->RoundedRect($this->cfg['PagePaddingLeft']+3, $this->cfg['PagePaddingTop']+16+3, 82, 119, 1, '1111', 'F', array(), $this->cfg['White']);
		...
		$this->pdf->setRTL(true);
		$this->pdf->Rect($this->cfg['PagePaddingLeft']+90, $this->cfg['PagePaddingTop']+125+16+2, 88, 125, 'F', array('all' => array()), $this->cfg['Green']);
		$this->pdf->RoundedRect($this->cfg['PagePaddingLeft']+90+3, $this->cfg['PagePaddingTop']+125+16+2+3, 82, 119, 1, '1111', 'F', array(), $this->cfg['White']);
	...
	public function BackPage( $left, $top )
	{
		...
		foreach ($data as $value) {
			...
			$this->pdf->Cell(88, 8, $value['title'], 0, 0, 'R');
			...
			foreach ($value['items'] as $item) {
				...
				$this->pdf->Write(1, $value['icon'], null, null, 'R', false, 0, false, false, 0, 0, array());
				$this->pdf->SetFont($this->cfg['FontBold'], '', 11);
				$this->pdf->SetTextColor(0,0,0);
				$this->pdf->SetXY($left+9, $top);
				$this->pdf->Write(1, $item[0], null, null, 'R', false, 0, false, false, 0, 0, array());
				$this->pdf->SetFont($this->cfg['FontItalic'], '', 11);
				$this->pdf->Write(1, ' '.$item[1], null, null, 'R', false, 0, false, false, 0, 0, array());
			}
